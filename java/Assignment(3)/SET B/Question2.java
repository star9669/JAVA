...
class LightMoterVehicle extends Vehicle
{
	...
	void accept()
	{
		...
		System.out.print("\nEnter Name company of Vehicle : ");
		company=sc.next()+sc.nextLine();
		
		System.out.print("Enter Price : ");
		price=sc.nextFloat();
		
		System.out.print("Enter MileAverege : ");
...
class HeavyMoterVhehicle extends Vehicle
{
	String department;
	float hours;
		...
		while(true)
		{
			...
			switch(x)
			{
				...
				case 3:
						...
						System.out.printf("%20s %20s %20s %10s %20s\n","Name","Address","Department","Salary","Full Time Staff");
						for(int a=0;a<i;a++)
						{
							f[a].display();
						}
				...
				case 4:
						System.out.println("\nPartTime Staff Info. :\n");
						System.out.printf("%20s %20s %20s %10s %10s %20s\n","Name","Address","Department","Hours","Rate per Hour","Part Time Staff");
						for(int a=0;a<i;a++)
						{
							p[a].display();
						}
