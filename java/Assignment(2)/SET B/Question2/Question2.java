...
class Total
{
	...
	void display()
	{
		System.out.printf("%20s %20s %20s %20s %20s %20s %20s %20s %20s %20s %20s %20s ",id,name,com,math,elec,th,prac,tsy,tty,tsy+tty,per,grade);
		System.out.println();
	}
...
public class Question2
{
	public static void main(String[] args)
	{
		...
		System.out.printf("%20s %20s %20s %20s %20s %20s %20s %20s %20s %20s %20s %20s  ","ID","NAME","COMPUTER(SY)","MATH(SY)","ELECRONIC(SY)","THEORY(TY)","PRACTICAL(TY)","TOTAL(SY)","TOTAL(TY)","TOTAL","PERCENTAGE","GRADE");
		System.out.println();
